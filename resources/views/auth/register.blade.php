...
<head>
    ...
    <title>Radio Intan - Register</title>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form action="{{ route('register.save') }}" method="POST" class="user">
                                ...
                                <div class="form-group">
                                    <input name="email" type="email" class="form-control form-control-user @error('email')is-invalid @enderror" id="exampleInputEmail"
                                        placeholder="Alamat Email nya kakak">
                                        @error('email')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input name="password" type="password" class="form-control form-control-user @error('password')is-invalid @enderror"
                                            id="exampleInputPassword" placeholder="Kasih password yaa">
                                            @error('password')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                    </div>
                                    <div class="col-sm-6">
                                        <input name="password_confirmation" type="password" class="form-control form-control-user @error('password_confirmation')is-invalid @enderror"
                                            id="examplePasswordConfirmation" placeholder="Masukin lagi password nya kakak">
                            ...
                            <hr>
                            <div class="text-center">
                                <a class="small" href="{{ route('login') }}">Udah punya akun? Gas Login!!</a>
                            </div>
                        </div>
                    </div>
                </div>
